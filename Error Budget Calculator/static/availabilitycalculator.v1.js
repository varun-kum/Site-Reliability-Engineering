...
function availabilityCalculator_showTime(downtime) {
    var output = "";
...
function availabilityCalculator() {
    ...
    var percentage = document.getElementById("availability_per");
        ...
        output += "<tr><td >" + currentLevel + "%</td>";
            for (i = 0; i < categories.length; i++) {
                if (currentLevel == 100) {
                    ...
                    output += "<td >" + availabilityCalculator_showTime(msToDowntime(categories[i])) + "</td>";
                }
            }
            output += "</tr></table>";
    }
